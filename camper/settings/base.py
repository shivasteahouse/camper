...
DEBUG_TOOLBAR_CONFIG = {
    ...
    'SHOW_TOOLBAR_CALLBACK': 'camper.settings.base.custom_show_toolbar',
...
SYSTEM_EMAIL_PREFIX = "[camper]"

## Log settings

LOG_LEVEL = logging.INFO
HAS_SYSLOG = True
SYSLOG_TAG = "http_app_camper"  # Make this unique to your project.
...
INVITATION_DEFAULT_DURATION_DAYS = 14
