"""
Starter fabfile for deploying the camper project.
...
# CHANGEME
env.hosts = ['user@camper.example.com']
env.code_dir = '/srv/www/camper'
env.project_dir = '/srv/www/camper/camper'
env.static_root = '/srv/www/camper/static/'
env.virtualenv = '/srv/www/camper/.virtualenv'
env.code_repo = 'git@github.com:user/camper.git'
env.django_settings_module = 'camper.settings'
...
def restart():
    ...
    with cd(env.code_dir):
        run("touch %s/camper/wsgi.py" % env.code_dir)
